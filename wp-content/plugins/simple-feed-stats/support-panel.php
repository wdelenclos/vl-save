...
$plugin_project = esc_html__('Simple Feed Stats', 'simple-feed-stats');
...
$title1 = esc_html__('Perishable Press Books', 'simple-feed-stats');
$title2 = esc_html__('Plugin Planet',          'simple-feed-stats');
$title3 = esc_html__('Donate via PayPal',      'simple-feed-stats');

$link1 = ' <a target="_blank" rel="noopener noreferrer" href="'. $url1 .'" title="'. $title1 .'">'. esc_html__('books',    'simple-feed-stats') .'</a> ';
$link2 = ' <a target="_blank" rel="noopener noreferrer" href="'. $url2 .'" title="'. $title2 .'">'. esc_html__('plugins',  'simple-feed-stats') .'</a>, ';
$link3 = ' <a target="_blank" rel="noopener noreferrer" href="'. $url3 .'" title="'. $title3 .'">'. esc_html__('donation', 'simple-feed-stats') .'</a>. ';

$message  = esc_html__('Thank you for using', 'simple-feed-stats') .' '. $plugin_project .'! ';
$message .= esc_html__('Please show support by purchasing one of my', 'simple-feed-stats') . $link1;
$message .= esc_html__('or', 'simple-feed-stats') . $link2 . esc_html__('or by making a', 'simple-feed-stats') . $link3;
$message .= esc_html__('Your generous support helps to ensure future development of', 'simple-feed-stats') .' '. $plugin_project .' ';
$message .= esc_html__('and is greatly appreciated.', 'simple-feed-stats');

$donate = esc_html__('Any size donation helps me to continue developing this free plugin and other awesome WordPress resources.', 'simple-feed-stats');
